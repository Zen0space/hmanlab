.PHONY: build build-release install clean test lint fmt check all deploy deploy-hmanlab deploy-r8r setup
...
# Deploy hmanlab landing + docs to Cloudflare Pages
deploy-hmanlab:
	bash landing/deploy.sh hmanlab
...
# Show help
help:
	@echo "HmanLab Rust - Build Commands"
	@echo ""
	@echo "Development:"
	...
	@echo ""
	@echo "Deploy:"
	@echo "  make deploy-hmanlab  - Deploy hmanlab landing + docs"
