...
if [ -n "${HMANLAB_VERSION:-}" ]; then
  VERSION="$HMANLAB_VERSION"
...
if [ -n "${HMANLAB_INSTALL_DIR:-}" ]; then
  INSTALL_DIR="$HMANLAB_INSTALL_DIR"
...
echo "Installing HmanLab ${VERSION} for ${OS_LABEL}/${ARCH_LABEL}${HW_NOTE}..."
...
echo ""
echo "HmanLab installed successfully! ${INSTALLED_VERSION}"
echo ""
echo "Get started:"
echo "  hmanlab onboard          # Interactive setup"
echo "  hmanlab agent -m 'Hello' # Talk to your agent"
echo ""
echo "Update later:  hmanlab update"
