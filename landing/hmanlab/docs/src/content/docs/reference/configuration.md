---
title: Configuration
description: HmanLab configuration file reference
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 3
---

HmanLab is configured via `~/.hmanlab/config.json`. All fields have sensible defaults.
...
Run `hmanlab config check` to validate your configuration. It reports:
