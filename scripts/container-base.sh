...
# Podman default/fallback docker. Podman vols: podman volume create hmanlab-{target,registry,benches}_cache
...
RUNTIME="podman"
TARGET_MOUNT="-v hmanlab-target_cache:/src/target:rw,U"
REGISTRY_MOUNT="-v hmanlab-registry_cache:/cargo-home:rw,U"
BENCH_MOUNT="-v hmanlab-benches_cache:/src/benches/target:rw,U"
...
printf "%s\n" target registry benches | xargs -I{} podman volume create --ignore hmanlab-{}_cache &>/dev/null
