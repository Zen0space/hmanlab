...
TENANTS_DIR="tenants"
VERSION="${HMANLAB_VERSION:-0.1.0}"
ENV="${HMANLAB_ENV:-production}"
...
x-hmanlab-defaults: &defaults
  image: hmanlab:latest
...
for dir in "$TENANTS_DIR"/*/; do
  ...
  tenant-$name:
    ...
    environment:
      - RUST_LOG=hmanlab=info
      - RUST_LOG_FORMAT=json
      - HMANLAB_HEALTH_PORT=9090
    labels:
      com.hmanlab.tenant: $name
      com.hmanlab.version: "$VERSION"
      com.hmanlab.env: "$ENV"
    healthcheck:
