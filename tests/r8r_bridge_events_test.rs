...
use hmanlab::r8r_bridge::dedup::Deduplicator;
use hmanlab::r8r_bridge::events::{BridgeEvent, BridgeEventEnvelope};
...
fn test_envelope_round_trip() {
    ...
    assert_eq!(envelope.event_type, "hmanlab.approval.decision");
    ...
    assert_eq!(parsed.event_type, "hmanlab.approval.decision");
...
fn test_health_ping_event() {
    ...
    assert_eq!(envelope.event_type, "hmanlab.health.ping");
...
fn test_ack_serialization() {
    use hmanlab::r8r_bridge::events::Ack;
