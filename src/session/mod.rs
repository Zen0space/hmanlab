...
//!
//! This module provides session management for HmanLab, including:
...
//!
//! ```
//! use hmanlab::session::{SessionManager, Message};
//!
//! #[tokio::main]
//! async fn main() {
...
/// `~/.hmanlab/sessions/` directory. Use `new_memory()` for testing
...
impl SessionManager {
    ...
    ///
    /// Sessions are stored in `~/.hmanlab/sessions/` as JSON files.
