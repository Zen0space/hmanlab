...
impl Session {
    ...
    /// # Example
    /// ```
    /// use hmanlab::session::{Session, Message};
    ///
...
impl Message {
    ...
    /// # Example
    /// ```
    /// use hmanlab::session::{Message, Role};
    ///
    ...
    /// # Example
    /// ```
    /// use hmanlab::session::{Message, ToolCall, Role};
    ///
