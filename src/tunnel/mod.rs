...
//!
//! ```rust,no_run
//! use hmanlab::tunnel::{create_tunnel, TunnelProvider};
//! use hmanlab::config::TunnelConfig;
//!
//! # async fn example() -> hmanlab::error::Result<()> {
...
mod tests {
    ...
    fn test_which_nonexistent_binary() {
        assert!(!which("hmanlab_nonexistent_binary_12345"));
    }
