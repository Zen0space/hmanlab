...
//! # Integration Pattern
//!
//! HmanLab <-> R8r form a symbiotic relationship:
//! - HmanLab calls r8r for deterministic workflows (HTTP, transform, data pipelines)
//! - R8r calls HmanLab via `agent` nodes for AI reasoning decisions
//!
//! # Example
//!
//! ```rust,ignore
//! use hmanlab::tools::{Tool, ToolContext};
//! use hmanlab::tools::r8r::R8rTool;
//! use serde_json::json;
//!
...
/// HmanLab's AI reasoning capabilities.
pub struct R8rTool {
    endpoint: String,
    client: Client,
}
