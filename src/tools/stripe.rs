...
impl StripeTool {
    ...
    /// Create from the global HmanLab configuration.
    ///
...
mod tests {
    ...
    fn test_stripe_env_overrides() {
        ...
        std::env::set_var("HMANLAB_STRIPE_SECRET_KEY", "sk_test_env_key");
        std::env::set_var("HMANLAB_STRIPE_DEFAULT_CURRENCY", "SGD");
        std::env::set_var("HMANLAB_STRIPE_WEBHOOK_SECRET", "whsec_env_secret");
        ...
        std::env::remove_var("HMANLAB_STRIPE_SECRET_KEY");
        std::env::remove_var("HMANLAB_STRIPE_DEFAULT_CURRENCY");
        std::env::remove_var("HMANLAB_STRIPE_WEBHOOK_SECRET");
    }
