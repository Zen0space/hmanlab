...
/// use hmanlab::tools::filesystem::ReadFileTool;
/// use serde_json::json;
///
...
/// ```rust
/// use hmanlab::tools::{Tool, ToolContext};
/// use hmanlab::tools::filesystem::WriteFileTool;
/// use serde_json::json;
///
/// # tokio_test::block_on(async {
...
/// ```rust
/// use hmanlab::tools::{Tool, ToolContext};
/// use hmanlab::tools::filesystem::ListDirTool;
/// use serde_json::json;
///
/// # tokio_test::block_on(async {
...
/// ```rust
/// use hmanlab::tools::{Tool, ToolContext};
/// use hmanlab::tools::filesystem::EditFileTool;
/// use serde_json::json;
///
/// # tokio_test::block_on(async {
...
mod tests {
    ...
    async fn test_read_file_tool() {
        ...
        let file_path = dir.path().join("hmanlab_test_read.txt");
        ...
        let result = tool
            .execute(json!({"path": "hmanlab_test_read.txt"}), &ctx)
            .await;
        assert!(result.is_ok());
