...
//! with parameter interpolation, making it easy to extend HmanLab's tool
...
//! use hmanlab::plugins::{discover_plugins, PluginRegistry};
//!
//! let dirs = vec![PathBuf::from("/home/user/.hmanlab/plugins")];
