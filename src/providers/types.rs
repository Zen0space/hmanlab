...
impl ToolDefinition {
    ...
    /// # Example
    /// ```
    /// use hmanlab::providers::ToolDefinition;
    /// use serde_json::json;
    ///
...
/// The provider is responsible for translating between HmanLab's
...
impl ChatOptions {
    ...
    /// # Example
    /// ```
    /// use hmanlab::providers::ChatOptions;
    ///
    ...
    /// ```
    /// use hmanlab::providers::ChatOptions;
    /// use hmanlab::providers::structured::OutputFormat;
    ///
...
impl LLMResponse {
    ...
    /// # Example
    /// ```
    /// use hmanlab::providers::LLMResponse;
    ///
    ...
    /// # Example
    /// ```
    /// use hmanlab::providers::{LLMResponse, LLMToolCall};
    ///
...
impl LLMToolCall {
    ...
    /// # Example
    /// ```
    /// use hmanlab::providers::LLMToolCall;
    ///
