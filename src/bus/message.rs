//! Message types for the HmanLab message bus
//!
...
impl InboundMessage {
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::message::InboundMessage;
    ///
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::message::{InboundMessage, MediaAttachment, MediaType};
    ///
...
impl OutboundMessage {
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::message::OutboundMessage;
    ///
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::message::{InboundMessage, OutboundMessage};
    ///
...
impl MediaAttachment {
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::message::{MediaAttachment, MediaType};
    ///
