//! Message Bus Module
//!
//! This module provides the core message bus infrastructure for HmanLab.
...
//!
//! ```
//! use hmanlab::bus::{MessageBus, InboundMessage, OutboundMessage};
//!
//! #[tokio::main]
//! async fn main() {
...
impl MessageBus {
    ...
    /// # Example
    /// ```
    /// use hmanlab::bus::{MessageBus, InboundMessage};
    ///
    /// #[tokio::main]
    /// async fn main() {
    ///     let bus = MessageBus::new();
