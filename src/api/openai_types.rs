...
//!
//! These types allow any OpenAI SDK to target HmanLab as a drop-in backend.
...
pub struct ChatCompletionResponse {
    ...
    pub model: String,
    /// Completion choices (always exactly one for HmanLab).
...
/// Convert OpenAI-format tool parameters into HmanLab `ToolDefinition` values.
...
/// Convert HmanLab `LLMToolCall` values into OpenAI tool call response format.
...
/// Convert OpenAI-format messages into HmanLab `Message` values.
///
