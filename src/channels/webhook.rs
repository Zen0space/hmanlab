...
//!
//! This module provides a generic HTTP webhook channel for HmanLab. External
...
//! use hmanlab::channels::webhook::{WebhookChannel, WebhookChannelConfig};
//! use hmanlab::channels::BaseChannelConfig;
//!
...
impl Default for WebhookChannelConfig {
    fn default() -> Self {
        Self {
            ...
            signature_header: "X-HmanLab-Signature-256".to_string(),
            sender_id: None,
            chat_id: None,
...
/// Generic HTTP webhook channel for HmanLab.
///
...
mod tests {
    ...
    fn test_webhook_config_defaults() {
        ...
        assert_eq!(config.signature_header, "X-HmanLab-Signature-256");
