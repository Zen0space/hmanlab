...
//!
//! When enabled, HmanLab acts as an ACP agent: it reads JSON-RPC from stdin
    ...
    async fn handle_initialize(
        ...
        let result = InitializeResult {
            ...
            agent_info: Some(AgentInfo {
                name: "hmanlab".to_string(),
                title: Some("HmanLab".to_string()),
...
impl AcpChannel {
    ...
    /// lifecycle (e.g. the `hmanlab acp` CLI subcommand).
