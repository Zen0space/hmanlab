...
mod tests {
    ...
    fn test_engine_from_empty_store() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_empty_{}.json",
            std::process::id()
        ));
    ...
    fn test_event_trigger_match() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_event_match_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_event_trigger_no_match() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_event_nomatch_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_event_trigger_channel_filter() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_chan_filter_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_event_trigger_channel_filter_pass() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_chan_pass_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_webhook_trigger_match() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_webhook_match_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_webhook_trigger_no_match() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_webhook_nomatch_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_cron_routines() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_cron_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_disabled_routines_ignored() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_disabled_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_concurrent_check_allows() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_conc_allow_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_concurrent_check_blocks() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_conc_block_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_start_finish_execution() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_start_finish_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
    ...
    fn test_invalid_regex_skipped() {
        let path = std::env::temp_dir().join(format!(
            "hmanlab_engine_test_invalid_regex_{}.json",
            std::process::id()
        ));
        let _ = std::fs::remove_file(&path);
