...
//!
//! Provides `hmanlab secrets encrypt|decrypt|rotate` to manage
//! encrypted secrets in `~/.hmanlab/config.json`.
...
use hmanlab::security::encryption::{is_secret_field, resolve_master_key, SecretEncryption};
