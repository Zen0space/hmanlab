...
/// use hmanlab::agent::compaction::truncate_messages;
///
/// let msgs = vec![
...
/// ```
/// use hmanlab::session::Message;
/// use hmanlab::agent::compaction::summarize_messages;
///
/// let msgs = vec![
///     Message::system("You are helpful."),
...
/// ```
/// use hmanlab::session::Message;
/// use hmanlab::agent::compaction::shrink_tool_results;
///
/// let msgs = vec![
///     Message::user("Hi"),
...
/// ```
/// use hmanlab::session::Message;
/// use hmanlab::agent::compaction::shrink_tool_results_progressive;
///
/// let msgs = vec![
...
/// ```
/// use hmanlab::session::Message;
/// use hmanlab::agent::compaction::try_recover_context;
///
...
/// ```
/// use hmanlab::session::Message;
/// use hmanlab::agent::compaction::build_summary_prompt;
///
/// let msgs = vec![
///     Message::user("Hello"),
