//! Error types for HmanLab
//!
//! This module defines all error types used throughout the HmanLab framework.
...
/// The primary error type for HmanLab operations.
#[derive(Error, Debug)]
pub enum ZeptoError {
...
/// A specialized `Result` type for HmanLab operations.
